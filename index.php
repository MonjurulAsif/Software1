...
<body>
    <div class="header">
        ...
        <nav class="navbar">
                ...
                <a href="http://localhost/asifprograms/software1/index.php">Book</a>
    ...
    <div class="container">
        <div class="box">
            ...
            <div class="icon1">
                ...
                <a href="http://localhost/asifprograms/software1/index.php"><i class="fas fa-chevron-right"></i> Book</a>
